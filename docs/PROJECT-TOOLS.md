...
| **Feature reference** | 每个 feature 的详情文档在 `docs/features/` |
| **`landing/`** | GitHub Pages landing page（vendored RocketTeam app，`pnpm frontend:build`）；详见 `landing/README.md` + `.github/workflows/landing-deploy.yml` |
